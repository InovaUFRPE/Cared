...
public class CuidadorMeusServicosAdapter extends ArrayAdapter<Agendamento> {
    private List<Agendamento> elementos;
    private List<Pessoa> pessoas;
    private SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm");

    public CuidadorMeusServicosAdapter(@NonNull List<Agendamento> elementos, @NonNull List<Pessoa> pessoas) {
        super(MyApplication.getContext(), R.layout.adapter_meus_servicos, elementos);
